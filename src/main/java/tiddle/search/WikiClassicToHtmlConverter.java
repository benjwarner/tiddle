...
public class WikiClassicToHtmlConverter implements WikiToHtmlConverter {
    private final static Logger LOG = Logger.getLogger(WikiClassicToHtmlConverter.class);
