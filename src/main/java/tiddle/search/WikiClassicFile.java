...
public class WikiClassicFile implements WikiFile {
    ...
    private final static Logger LOG = Logger.getLogger(WikiClassicFile.class);
    ...
    private final WikiToPlainTextConverter wikiToPlainTextConverter;

    public WikiClassicFile(String path, String content) {
        super();
        this.path = path;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        WikiClassicFile other = (WikiClassicFile) obj;
        if (path == null) {
            if (other.path != null)
                return false;
