...
import tiddle.search.WikiFileLoader;
import tiddle.search.WikiFiles;
import tiddle.util.XmlUtils;


public class WikiFileLoaderTest {
	@Test
	public void testLoadSingleFileFromClasspath() throws FileNotFoundException, IOException{
	...
	@Test
	public void testLoadSingleFileFromStraightFile() throws FileNotFoundException, IOException{
	...
	@Test
	public void testLoadMultipleFilesFromRelativeDirectory() throws FileNotFoundException, IOException{
		...
		final List<WikiFile> expectedWikiFilesList = new ArrayList<WikiFile>();
	...
	@Test
	public void testLoadMultipleFilesFromRelativeNestedDirectory() throws FileNotFoundException, IOException{
