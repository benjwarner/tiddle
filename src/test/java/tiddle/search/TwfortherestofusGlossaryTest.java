...
public class TwfortherestofusGlossaryTest {
	...
	public void testGlossary(){
		...
		final String expectedOutput = 
			"<table class=\"twtable\"><tbody><tr class=\"oddRow\"><td style=\"background-color: #dddddd;\"><strong>Case-senstive search</strong></td><td>A function of TiddlyWiki whereby the user can search for a word or phrase with precise upper and lowercase specifications.</td></tr>\n" +
